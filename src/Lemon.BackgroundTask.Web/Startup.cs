...
using Lemon.BackgroundTask.Web.Authentication;
...
namespace Lemon.BackgroundTask.Web
{
    public class Startup
    {
        ...
        private void ConfigureSwaggerServices(IServiceCollection services)
        {
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Lemon.BackgroundTask Service API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Lemon.BackgroundTask Service API");
            });
        }
    }
}
